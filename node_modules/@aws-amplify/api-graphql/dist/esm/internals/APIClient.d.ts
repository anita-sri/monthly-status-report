 ...
 * ```
 */
export declare function customSelectionSetToIR(modelInstrospection: ModelIntrospectionSchema, modelName: string, selectionSet: string[]): Record<string, string | object>;
/**
...
export declare function generateSelectionSet(modelInstrospection: ModelIntrospectionSchema, modelName: string, selectionSet?: string[]): string;
export declare function generateGraphQLDocument(modelInstrospection: ModelIntrospectionSchema, modelName: string, modelOperation: ModelOperation, listArgs?: ListArgs | QueryArgs, indexMeta?: IndexMeta): string;
